...
public class TCSProxyXMLObjRequest implements IHttpObjRequestable{

	Logger logger = LogManager.getLogger(TCSProxyXMLObjRequest.class);
	...
	public void buildBodyRequest(String body,Map<String,Object> map) throws MapExpressionEvaluationException{
		...
		map.put("username", connector.getUserName());
		map.put("password", connector.getPassword());
